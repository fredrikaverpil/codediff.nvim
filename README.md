...
git cherry-pick origin/feat/compact-mode
git cherry-pick origin/feat/inline-diff-api
git cherry-pick origin/feat/mark-as-viewed
```
...
upstream/main
  ...
  + feat(ui): add compact mode to fold unchanged regions in diff view
